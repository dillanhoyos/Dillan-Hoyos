...
void TapeDelayAudioProcessorEditor::paint (Graphics& g)
{
    ...
    g.drawFittedText (TRANS ("Normal Signal, DH"), box.removeFromLeft (width), Justification::centred, 1);
    g.drawFittedText (TRANS ("Time, DH"), box.removeFromLeft (width), Justification::centred, 1);
    g.drawFittedText (TRANS ("Feedback, DH"), box.removeFromLeft (width), Justification::centred, 1);
}
